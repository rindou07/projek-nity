...
const Footer = () => {
  return (
    <footer className="bg-gray-50 pt-16 border-t border-gray-200 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li><Link href="/#tentang" className="hover:text-brand-primary flex items-center gap-1"><ChevronRight className="w-3 h-3 text-brand-primary" /> Tentang Kami</Link></li>
              <li><Link href="/catalog" className="hover:text-brand-primary flex items-center gap-1"><ChevronRight className="w-3 h-3 text-brand-primary" /> Katalog Produk</Link></li>
            </ul>
          </div>

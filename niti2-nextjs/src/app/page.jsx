    ...
    <div className="w-full">
      ...
      <section className="w-full bg-white pt-10 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 h-[400px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl bg-gray-200">
             {/* Note: In Next.js, images should go to public folder. We assume toko-niti2.jpg is there or will be moved */}
            <img 
              src="/toko-niti2.jpg" 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="h-[400px] rounded-2xl overflow-hidden shadow-lg border-4 border-white bg-gray-100">
              <iframe 
